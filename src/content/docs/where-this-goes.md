...
Suped 0.4.0 supplies the workspace, curated catalogue, guided provider selection, sign-in steps, and status checks. The work continues on making that path dependable: installation, authentication, persistence, clear errors, and a straightforward hand-off. Catalogue entries need a working setup path, not just a download link.
