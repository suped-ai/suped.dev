...
These commands are included in Suped **0.2.0**. The examples use the `suped` shorthand after `npm i -g suped@latest`; replace it with `npx suped@latest` if you prefer to run without a global installation.
